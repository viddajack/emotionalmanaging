...
SOUNDS = [
    ...
    {
        "id": "assez_travaille remastered",
        "filename": "assez travaille remastered.mp3",
        "title": "Assez Travaillé remastered",
        "tag": "Sonnerie · assez travaille Remastered",
        "desc": "Une composition ciselée note après note. Le résultat d'heures passées à équilibrer chaque détail.",
        "price": "0,99 €",
        "paypal": "https://paypal.me/DavidMarchal144/0.99",
    },
    {
        "id": "changeffect remastered",
        "filename": "changeffect remastered.mp3",
        "title": "ChangEffect remastered",
        "tag": "Sonnerie · changeffect remastered",
